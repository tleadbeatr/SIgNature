...
// the AI prompt 
const prompt =
    `SIgNature is a playful SI unit and dimensional analysis game. A participant has constructed the following physical expression from physics concepts, units and mathematical operations:\n\n` +
    `SIgNature:\n<<<\n${signature}\n>>>\n\n` +
    'Explain what this complete expression represents physically. You may simplify the units to discover its physical dimensions and meaning, but every factor in the original expression must remain accounted for. If the resulting quantity has a familiar physical interpretation, identify it. If the combination is unusual, explain why.\n\n' +
